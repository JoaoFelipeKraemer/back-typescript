...
console.log(`- Calcule a área de um losango: ${Ex.getLosangleArea(32, 18)}cm²`);
console.log(`- Calcule a área de um losango: ${Ex.getLosangleArea(200, 50)}cm²`);
console.log(`- Calcule a área de um losango: ${Ex.getLosangleArea(75, 25)}cm²`);
console.log(`- Calcule a área de um trapézio: ${Ex.getTrapezioArea(100, 70, 50)}cm²`);
console.log(`- Calcule a área de um trapézio: ${Ex.getTrapezioArea(75, 50, 35)}cm²`);
console.log(`- Calcule a área de um trapézio: ${Ex.getTrapezioArea(150, 120, 80)}cm²`);
